...
public class FavoriteFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Log.i(getClass().toString(), "Creating a new Favorite Dialog");
        ...
        return new AlertDialog.Builder(getActivity())
                .setView(view).setTitle(R.string.DialogTitle).setPositiveButton(R.string.FavoriteUser,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (dataAccessObject.checkFave(User.getCurrentUser().getEmail(), faveEmail) == false) {
                                    dataAccessObject.insertFavorite(User.getCurrentUser().getEmail(), faveEmail);
                                }
                            }
                        }
